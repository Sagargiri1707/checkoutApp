        ...
        <div className="flex-grow flex flex-col px-2 py-2 bg-white shadow-md">
            ...
            <form onSubmit={submitForm}>
                ...
                <div className="flex flex-col mb-1">
                    ...
                    <input value={formState.phone} onChange={handleFormChange} minLength={10} maxLength={13} type="text" id="phone" className="rounded border border-gray-300 px-4 py-2 focus:ring focus:ring-blue-200" required={true} />
                </div>
                <div className="flex flex-col mb-1">
                ...
                <button className="inline-flex items-center px-4 py-1 text-white font-bold rounded shadow-sm mt-2  bg-rose-400 hover:bg-rose-600" type="submit">Add New Address</button>
