...
function FinalConfirmation(){
    ...
    const itemBreakUp = productDetails.productData.reduce((acc,i)=>{
    acc.totalPrice += i.itemPrice.originalPrice*i.quantity;
            acc.discount += (i.itemPrice.originalPrice - i.itemPrice.discountedPrice)*i.quantity;
        ...
        <div className="mx-auto w-96 mt-8 p-4">
            ...
            <div className="mt-4">
                <div className="flex justify-between">
                    ...
                    <span className="text-xl font-bold">₹{itemBreakUp.finalPrice.toFixed(2)}</span>
                </div>
            </div>
        </div>
    );
